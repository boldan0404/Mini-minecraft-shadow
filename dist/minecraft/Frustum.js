...
export var FrustumPlane;
(function (FrustumPlane) {
    FrustumPlane[FrustumPlane["LEFT"] = 0] = "LEFT";
    FrustumPlane[FrustumPlane["RIGHT"] = 1] = "RIGHT";
    FrustumPlane[FrustumPlane["BOTTOM"] = 2] = "BOTTOM";
    FrustumPlane[FrustumPlane["TOP"] = 3] = "TOP";
    FrustumPlane[FrustumPlane["NEAR"] = 4] = "NEAR";
    FrustumPlane[FrustumPlane["FAR"] = 5] = "FAR";
